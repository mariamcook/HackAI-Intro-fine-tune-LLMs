...
1. Fine-tune the BERT LLM on text labelled as being from UK Labour and Conservative Party politicians' contributions to 2023 UK government debates, save and reload the model. (For completeness the notebook 1c used to scrape and filter this text is also included in this repo). Debates scraped from: https://www.theyworkforyou.com/
